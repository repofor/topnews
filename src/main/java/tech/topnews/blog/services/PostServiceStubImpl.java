...
public class PostServiceStubImpl implements PostService {
    private List<Post> posts = new ArrayList<Post>() {{
        ...
        add(new Post(2L, "Second Post", "Second post content:<ul><li>line 1</li><li>line 2</li></p>", new User(10L, "pesho10")));
        add(new Post(3L, "Post #3", "<p>The post number 3 nice</p>", new User(10L, "merry")));
